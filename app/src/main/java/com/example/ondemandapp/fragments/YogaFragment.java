 ...
 * {@link YogaFragment.OnFragmentInteractionListener} interface
...
public class YogaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rv_yoga = v.findViewById(R.id.rv_yoga);

        womenlist.clear();
        womenlist.add(new Womenmodel("Fitness Trainer at Home", R.drawable.fitness_trainer,"29"));
        womenlist.add(new Womenmodel("Yoga Trainer at Home", R.drawable.yoga_trainer,"30"));

        rv_yoga.setLayoutManager(new LinearLayoutManager(getActivity(), RecyclerView.VERTICAL, false));
        womenAdapter = new WomenAdapter(getActivity(), womenlist);
        rv_yoga.setAdapter(womenAdapter);
        return v;
    }
