...
List<Womenmodel> womenlist=new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rv_women=v.findViewById(R.id.rv_women);


        womenlist.clear();
        womenlist.add(new Womenmodel("Salon at home for Women",R.drawable.women_salon,"1"));
        womenlist.add(new Womenmodel("Makeup and Hairstyling",R.drawable.makeup_hairstyle,"2"));

        rv_women.setLayoutManager(new LinearLayoutManager(getActivity(),RecyclerView.VERTICAL,false));
        womenAdapter=new WomenAdapter(getActivity(),womenlist);
        rv_women.setAdapter(womenAdapter);
