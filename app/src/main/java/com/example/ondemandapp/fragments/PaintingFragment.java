 ...
 * {@link PaintingFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link PaintingFragment#newInstance} factory method to
...
public class PaintingFragment extends Fragment {
    ...
    public static PaintingFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rv_painting=v.findViewById(R.id.rv_painting);


        womenlist.clear();
        womenlist.add(new Womenmodel("House Painters",R.drawable.hpuse_painters,"31"));

        rv_painting.setLayoutManager(new LinearLayoutManager(getActivity(), RecyclerView.VERTICAL,false));
        womenAdapter=new WomenAdapter(getActivity(),womenlist);
        rv_painting.setAdapter(womenAdapter);
        return v;
    }
